...
#ifndef SUNDANCESHPERE_H_
#define SUNDANCESHPERE_H_
...
/** This class models a Sphere in 2D.<br>
 * This is one of the simplest curves */
class Sphere: public Sundance::CurveBase
{
public:

	/** The constructor of the Sphere in 2D
	 ...
	 * @param evalPoint point where the Sphere equation is evaluated <br>
